...
export const TABLA_ISO_10625 = [
  ...
  { tamano: '015', caudalLmin: 0.6, colorEs: 'Verde trafico', colorEn: 'Traffic green', ral: '6024-P', hex: '#008754', verificado: true },
  { tamano: '02', caudalLmin: 0.8, colorEs: 'Amarillo zinc', colorEn: 'Zinc yellow', ral: '1018-P', hex: '#FACA30', verificado: true },
  { tamano: '025', caudalLmin: 1.0, colorEs: 'Violeta senal', colorEn: 'Signal violet', ral: '4008-P', hex: '#904684', verificado: true },
  { tamano: '03', caudalLmin: 1.2, colorEs: 'Azul genciana', colorEn: 'Gentian blue', ral: '5010-P', hex: '#13447C', verificado: true },
  {
    tamano: '035',
    caudalLmin: 1.4,
    colorEs: 'Rojo purpura',
    colorEn: 'Purple red',
    ral: '3004-P',
    hex: '#701F29',
    verificado: true,
    nota:
      'La edicion 2018 cambio este color: antes era Rojo marron RAL 3011 (ISO 10625:2005). ' +
  ...
  { tamano: '05', caudalLmin: 2.0, colorEs: 'Marron nuez', colorEn: 'Nut brown', ral: '8011-P', hex: '#5A3A29', verificado: true },
  { tamano: '06', caudalLmin: 2.4, colorEs: 'Gris senal', colorEn: 'Signal grey', ral: '7004-P', hex: '#9EA0A1', verificado: true },
  { tamano: '08', caudalLmin: 3.2, colorEs: 'Blanco trafico', colorEn: 'Traffic white', ral: '9016-P', hex: '#F7FBF5', verificado: true },
  ...
  { tamano: '16', caudalLmin: 6.4, colorEs: 'Marron anaranjado', colorEn: 'Orange brown', ral: '8023-P', hex: '#A65E2F', verificado: true },
  {
    tamano: '18',
    caudalLmin: 7.2,
  ...
  },
  {
    ...
    verificado: 'parcial',
    nota:
      'Caudal verificado en el prologo de ISO 10625:2018 (8,0 L/min, tamano 20). El color ' +
      'esta en la Tabla 2 (caudales altos), que no aparece en la vista previa disponible: ' +
      'queda PENDIENTE y no se rellena por extrapolacion.',
  },
];
